...
@Component({
  selector: 'app-grapheditor-main',
  templateUrl: './grapheditor-main.component.html',
  styleUrls: ['./grapheditor-main.component.scss']
})
export class GrapheditorMainComponent implements OnInit {
